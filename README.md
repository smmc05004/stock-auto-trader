...
AI와 개발자는 작업 전에 [AGENTS.md](./AGENTS.md)와 [작업 및 이미지 배포 규약](./docs/development-and-deployment.md)을 읽습니다. 모든 변경은 작업 브랜치와 PR로 관리합니다. main 머지 후 Docker 이미지 자동 배포는 승인된 목표이며, 실제 구현 상태는 규약의 상태 표를 확인합니다.
